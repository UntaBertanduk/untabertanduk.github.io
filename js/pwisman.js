$(function () {
  ...
  var pwData = {
    datasets: [{
      data: [44.27, 20.38, 18.21, 11.36, 5.77],
      backgroundColor: [
        "#F9A38A",
        "#ECD385",
        "#F2E2CF",
  ...
  var pwOptions = {
    ...
    tooltips: {
      callbacks: {
        enabled: true,
        mode: 'single',
        label: function (tooltipItems, pwData) {
          var i = tooltipItems.index;
          return pwData.labels[i] + ": " + pwData.datasets[0].data[i] + "%";
        }
      }
    }
  };
  ...
  var rlkData = {
    ...
    datasets: [{
      label: 'Lama Kunjungan',
      data: [8.53, 8.42, 8.64, 8.87, 13.62, 59.88],
      backgroundColor: "#fff",
      borderColor: '#52CDFF',
      borderWidth: 1.5,
      fill: false,
